...
import classes from "./DokumenKebijakanKeuangan.module.css";
...
// --- KOMPONEN UTAMA ---
export default function DokumenKebijakanKeuangan() {
    ...
    return (
        <>
            ...
            <BackgroundImage
                src="https://res.cloudinary.com/degzbxlnx/image/upload/v1758699614/candi_muaro_jambi_avr8av.jpg"
                    ...
                    <Container size="lg">
                        <Center>
                            <Title order={1} c="white" mb="xl">
                                DOKUMEN KEBIJAKAN DAN KEUANGAN
                            </Title>
                        </Center>
